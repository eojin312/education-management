...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            ...
            <div class="sidebar-brand-text mx-3">학사관리</div>
        </a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="/school/list">학교목록</a>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="chart-area">
                                    ...
                                    <canvas id="myAreaChart" style="display: block; width: 947px; height: 400px;"
                                            width="947" height="400" class="chartjs-render-monitor"></canvas>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <div class="chart-pie pt-4 pb-2">
                                    ...
                                    <canvas id="myPieChart" width="433" height="317" class="chartjs-render-monitor"
                                            style="display: block; width: 433px; height: 317px;"></canvas>
                                </div>
...
<script src="/static/bootstrap/theme/sbadmin2/Chart.min.js"></script>
<script src="/static/bootstrap/theme/sbadmin2/chart-area-demo.js"></script>
<script src="/static/bootstrap/theme/sbadmin2/chart-pie-demo.js"></script>
